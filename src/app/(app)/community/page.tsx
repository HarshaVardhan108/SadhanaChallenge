  ...
  return (
    <div>
      ...
      <GlassCard className="mb-8" strong>
        ...
        <div className="mt-3 flex flex-wrap items-center justify-between gap-3">
          <div className="flex gap-2 text-[var(--text-muted)]">
            ...
            <span className="self-center text-xs">Realizations · Photos · Seva</span>
          </div>
          <Button
            variant="gold"
            size="sm"
      ...
      <div className="space-y-4">
        {posts.length === 0 ? (
          <GlassCard lift={false} className="py-10 text-center">
            <MessageCircle className="mx-auto h-9 w-9 text-peacock/70" />
            <p className="mt-3 font-serif text-lg font-bold text-krishna">
              No posts yet
            </p>
            <p className="mt-1 text-sm text-[var(--text-muted)]">
              Be the first to share a realization, seva update, or temple moment.
            </p>
          </GlassCard>
        ) : (
          posts.map((post) => (
